...
Write-Host ".\tools\setup-keyvault-secrets.ps1 -NewSqlPassword 'YOUR_NEW_SECURE_PASSWORD' -NewInstructionsPassword 'YOUR_NEW_INSTRUCTIONS_PASSWORD'" -ForegroundColor White
