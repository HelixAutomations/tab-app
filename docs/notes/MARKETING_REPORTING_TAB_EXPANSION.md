...
>
> **Verified:** 2026-06-12 against branch `main`. If you're reading this more than 30 days later, re-verify file/line refs before executing.
...
```yaml
# Stash metadata
id: marketing-reporting-tab-expansion                          # used in INDEX cross-refs
verified: 2026-06-12
branch: main
touches:
  client: []
