...
- **Current code still pre-restructure (verified 2026-04-24):** [src/tabs/resources/Resources.tsx](../../src/tabs/resources/Resources.tsx) is still the old flat link hub, and [src/tabs/roadmap/Roadmap.tsx](../../src/tabs/roadmap/Roadmap.tsx) still mounts `ActivityCardLabPanel`. Do not treat the brief as already half-landed in code; the Templates surface still needs to be stood up explicitly.
- **File-shape warning:** [src/tabs/resources/Resources.tsx](../../src/tabs/resources/Resources.tsx) is a large legacy tab with lots of embedded tool state. Phase A should decompose it into sections (`Templates`, `System behaviour`, `Quick links`) rather than bolting feedback-loop UI directly into the existing monolith.
