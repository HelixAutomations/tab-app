...
>
> **Verified:** <DATE> against branch `<BRANCH>`. If you're reading this more than 30 days later, re-verify file/line refs before executing.
...
```yaml
# Stash metadata
id: <ID>                          # used in INDEX cross-refs
verified: <DATE>
branch: <BRANCH>
touches:
  client: []
