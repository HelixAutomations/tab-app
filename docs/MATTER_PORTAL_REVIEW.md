...
> **Note:** This brief predates the stash routine. Original review date 2025-07-15 — file/line refs are likely stale. Re-verify before executing.

```yaml
# Stash metadata
id: matter-portal-review
verified: 2025-07-15
branch: unknown
stale: true
touches:
  client:
    - submodules/instruct-pitch/src/MatterPortal.tsx
    - submodules/instruct-pitch/src/MatterPortal.css
    - submodules/instruct-pitch/src/components/StageTracker.tsx
    - submodules/instruct-pitch/src/App.tsx
  server:
    - submodules/instruct-pitch/server/routes/matter-portal.js
  submodules:
