      ...
      return (
        <TooltipHost content="Delete this leave request">
          <IconButton
            ...
            styles={{
              root: {
                color: isDarkMode ? colours.cta : '#D65541',
                height: '28px',
                width: '28px',
              },
              rootHovered: {
                color: isDarkMode ? '#D65541' : '#D65541',
                backgroundColor: isDarkMode ? 'rgba(214, 85, 65, 0.1)' : 'rgba(214, 85, 65, 0.1)',
              }
            }}
          />
        </TooltipHost>
    ...
    <>
      <style key={isDarkMode ? 'dark' : 'light'}>
        ...
        {isDarkMode && `
          ...
          .rdrCalendarWrapper {
            background: linear-gradient(135deg, rgba(0, 3, 25, 0.95) 0%, rgba(6, 23, 51, 0.9) 100%) !important;
          ...
          .rdrMonthAndYearPickers select {
            background-color: rgba(0, 3, 25, 0.8) !important;
            color: ${colours.dark.text} !important;
            border: 1px solid rgba(125, 211, 252, 0.24) !important;
          ...
          .rdrDateDisplayItem {
            background: rgba(0, 3, 25, 0.8) !important;
            border: 1px solid rgba(125, 211, 252, 0.24) !important;
          ...
          >
            ...
            <div style={{ 
              ...
              <div style={{
                ...
                <Stack tokens={{ childrenGap: 8 }}>
                  ...
                  <div style={{ height: '1px', background: isDarkMode ? 'rgba(160, 160, 160, 0.12)' : 'rgba(0, 3, 25, 0.06)' }} />
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <Stack tokens={{ childrenGap: 12 }}>
                    ...
                    {(() => {
                      ...
                      return (
                        <div style={{
                          ...
                          padding: '1rem',
                          borderRadius: 0,
                          background: isDarkMode ? 'rgba(54, 144, 206, 0.04)' : 'rgba(54, 144, 206, 0.04)',
                ...
                <div
                  style={{
                    border: `1.5px dashed ${isDarkMode ? 'rgba(54, 144, 206, 0.3)' : 'rgba(54, 144, 206, 0.3)'}`,
                    borderRadius: 0,
                    height: '52px',
                    display: 'flex',
                    alignItems: 'center',
                    ...
                    cursor: 'pointer',
                    backgroundColor: isDarkMode ? 'rgba(6, 23, 51, 0.3)' : '#ffffff',
                    transition: 'all 0.2s ease',
                  }}
                  onClick={handleAddDateRange}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.backgroundColor = isDarkMode ? 'rgba(54, 144, 206, 0.04)' : 'rgba(54, 144, 206, 0.04)';
                    e.currentTarget.style.borderColor = isDarkMode ? 'rgba(54, 144, 206, 0.5)' : 'rgba(54, 144, 206, 0.5)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.backgroundColor = isDarkMode ? 'rgba(6, 23, 51, 0.3)' : '#ffffff';
                    e.currentTarget.style.borderColor = isDarkMode ? 'rgba(54, 144, 206, 0.3)' : 'rgba(54, 144, 206, 0.3)';
                  }}
                >
            ...
            <Stack tokens={{ childrenGap: 12 }}>
              <TextField
                ...
                styles={{
                  ...
                  fieldGroup: {
                    ...
                    selectors: {
                      ':hover': { borderColor: isDarkMode ? 'rgba(160, 160, 160, 0.3)' : 'rgba(0, 0, 0, 0.15)' },
              ...
              <div style={{
                ...
                border: `1px solid ${isDarkMode ? 'rgba(160, 160, 160, 0.12)' : 'rgba(0, 3, 25, 0.06)'}`,
              }}>
                <Stack tokens={{ childrenGap: 8 }}>
            ...
            <div style={{ marginTop: '16px' }}>
              ...
              {confirmationMessage && (
                <div style={{ 
                  ...
                  color: colours.green,
                  padding: '12px 16px',
                  backgroundColor: isDarkMode ? 'rgba(32, 178, 108, 0.08)' : 'rgba(32, 178, 108, 0.06)',
                  borderRadius: 0,
              ...
              {errorMessage && (
                <div style={{ 
                  ...
                  color: colours.cta,
                  padding: '12px 16px',
                  backgroundColor: isDarkMode ? 'rgba(214, 85, 65, 0.08)' : 'rgba(214, 85, 65, 0.06)',
                  borderRadius: 0,
                  borderLeft: '3px solid #D65541',
            ...
            <div style={infoBoxStyle(isDarkMode)}>
              ...
              <Stack tokens={{ childrenGap: 10 }}>
                <Stack horizontal verticalAlign="center" tokens={{ childrenGap: 8 }}>
                  ...
                  {isDemoMode && (
                    <span
                      title="Decorative-by-design: demo leave records are mocked. No bookings will be made."
                      style={{
                        fontSize: 10,
                        fontWeight: 700,
                        letterSpacing: '0.4px',
                        ...
                        color: isDarkMode ? 'rgba(255,255,255,0.7)' : 'rgba(13,47,96,0.7)',
                        lineHeight: 1.1,
                      }}
                    >
                      Demo numbers
          ...
          {userLeaveHistory.length > 0 ? (
              ...
              <DetailsList
                ...
                styles={{
                  root: {
                    ...
                    '.ms-DetailsRow': {
                      backgroundColor: 'transparent',
                      borderBottom: `1px solid ${isDarkMode ? 'rgba(160, 160, 160, 0.08)' : 'rgba(0, 3, 25, 0.05)'}`,
                      minHeight: '48px'
                    },
                  ...
                  headerWrapper: {
                    backgroundColor: isDarkMode ? 'rgba(17, 24, 39, 0.5)' : 'rgba(244, 244, 246, 0.8)',
                    borderBottom: `1px solid ${isDarkMode ? 'rgba(160, 160, 160, 0.15)' : 'rgba(0, 3, 25, 0.08)'}`,
                    '.ms-DetailsHeader': {
                      paddingTop: '0px',
                      borderTop: 'none'
                    },
            ...
            <div style={{
              ...
              <Icon 
                ...
                style={{ 
                  fontSize: '32px', 
                  color: isDarkMode ? 'rgba(160, 160, 160, 0.25)' : 'rgba(107, 107, 107, 0.25)',
                  marginBottom: '8px'
                }} 
              />
              <Text style={{ 
        ...
        <Stack tokens={{ childrenGap: 16 }} style={{ padding: '0 24px 24px' }}>
          {deleteTarget?.status?.toLowerCase() === 'booked' && (
            <div style={{
              ...
              <Stack horizontal verticalAlign="center" tokens={{ childrenGap: 8 }}>
                <Icon iconName="Warning" style={{ color: isDarkMode ? colours.yellow : '#FF8C00' }} />
                <Text style={{ fontSize: '13px', color: isDarkMode ? colours.yellow : '#FF8C00' }}>
        ...
        <DialogFooter>
          <DefaultButton 
            ...
            styles={{
              root: {
                backgroundColor: 'transparent',
                border: `1px solid ${isDarkMode ? 'rgba(160, 160, 160, 0.3)' : 'rgba(0, 0, 0, 0.2)'}`,
              },
              rootHovered: {
          ...
          <PrimaryButton 
            ...
            styles={{
              root: {
                backgroundColor: isDarkMode ? colours.cta : '#D65541',
                border: 'none',
              },
              rootHovered: {
              ...
              rootDisabled: {
                backgroundColor: isDarkMode ? 'rgba(214, 85, 65, 0.5)' : 'rgba(214, 85, 65, 0.5)',
              }
            }}
          >
