...
export const CAPABILITIES = {
  ...
  'tier:admin': {
    ...
    kind: 'tier',
    label: 'Admin tier',
    description: 'Trusted internal support/admin feature tier. Personal data scope.',
    defaultAllow: ['user:LZ', 'user:AC', 'user:KW', 'user:JW', 'user:LA', 'user:LD', 'user:EA', 'user:WH'],
  },
  ...
  'feature:reports': {
    ...
    defaultAllow: ['user:LZ', 'user:AC', 'user:KW', 'user:JW', 'user:EA', 'user:WH'],
  },
  'feature:firm-wide-home': {
    key: 'feature:firm-wide-home',
    kind: 'feature',
    label: 'Firm-wide Home billing',
    description: 'Home billing, matters, and enquiry aggregate scope for non-billing dev, operations, and reception users.',
    defaultAllow: ['user:LZ', 'user:KW', 'user:LD', 'user:EA', 'user:WH'],
  },
  'feature:home-support-streams': {
    key: 'feature:home-support-streams',
    kind: 'feature',
    label: 'Home To Do/L&D support streams',
    description: 'Everyone scope for Home To Do, L&D, and document-transfer support cards. Separate from firm billing.',
    defaultAllow: ['user:LZ', 'user:AC', 'user:KW', 'user:JW', 'user:LA', 'user:LD', 'user:EA', 'user:WH'],
  },
  'feature:all-calls': {
    key: 'feature:all-calls',
    kind: 'feature',
    label: 'All calls scope',
    description: 'Call centre all-person scope. Separate from firm-wide Home billing.',
    defaultAllow: ['user:LZ', 'user:AC', 'user:JW', 'user:LA'],
  },
  'feature:hub-controls': {
    key: 'feature:hub-controls',
    kind: 'feature',
    label: 'Private hub tools',
    description: 'DebugLatencyOverlay, CCL diff drawer, cache monitor, and dev preview locks.',
    defaultAllow: ['user:LZ'],
  },
  'feature:activity-tab': {
    ...
    defaultAllow: ['user:LZ', 'user:AC', 'user:KW', 'user:EA'],
  },
  'feature:tasks-tab': {
